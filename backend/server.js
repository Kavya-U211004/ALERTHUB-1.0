...
// MongoDB Connection
mongoose.connect('mongodb+srv://Kavya:11122251k@kavya.fr06fpp.mongodb.net/Personalization', {
...
app.use(
  session({
    ...
    store: MongoStore.create({ mongoUrl: 'mongodb+srv://Kavya:11122251k@kavya.fr06fpp.mongodb.net/Personalization' }),
    cookie:{
      maxAge:null
    }
  })
...
//   const { content, pincode, address } = req.body;
  
//   try {
//     const updatedPost = await Post.findByIdAndUpdate(postId, { content, pincode, address }, { new: true });
//     if (!updatedPost) {
